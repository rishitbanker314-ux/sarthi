...
2. Do not ask for everything at once. Ask one question at a time. Total questions must be between 8 and 12.
...
1. If you need more information to derive the nine dimensions (and you have asked fewer than 12 questions), output `complete: false` and provide the next `question`.
